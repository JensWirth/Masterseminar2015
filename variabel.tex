...
\end{equation}
für alle $\xi\in\R^n$ verschwindet. Für solche Operatoren ist der Kommutator zwischen $P(x,\D)$ und ${}^t P(x,\D)$ ein Operator der Ordnung $2m-2$ (statt trivialerweise nur $2m-1$). Operatoren mit $\{p,\overline p\}=0$ werden als \eIndex[Differentialoperator]{wesentlich normal} bezeichnet.
