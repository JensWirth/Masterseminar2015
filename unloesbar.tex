...
\end{equation}
Nach Konstruktion ist $B^\infty_0(\Omega)$ abgeschlossener Teilraum von $B^\infty(\Omega)$ und für $\omega\Subset\Omega$ ist die Einschränkung auf $\omega$ surjektiv von $B^\infty_0(\Omega)$ auf $B^\infty(\omega)$. Das nachfolgende Lemma liefert damit insbesondere die im Beweis verwendete Abgeschlossenheit der Mengen $M_N$.
\end{rem}
