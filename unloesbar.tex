...
Zunächst benötigen wir eine Verallgemeinerung von Satz~\ref{thm:4:Umkehrung}.

\begin{thm}[{\cite[Theorem 3.1]{Hormander:1960a}}]\label{thm:3.1_hoer}
Sei $\Omega\subset\mathbb{R}^n$ ein Gebiet und $P(x,\D)$ ein Differentialausdruck erster Ordnung  mit analytischen Koeffizienten. Angenommen, für jedes $f\in \rmC_0^\infty(\Omega)$  existiert eine distributionelle Lösung $u\in\mathscr D'(\Omega)$ zu
...
\end{equation}
\end{thm}
\begin{proof}[Beweisskizze] {\bf TODO}
\end{proof}
...
\begin{thm}[{\cite[Theorem 3.2]{Hormander:1960a}}]\label{thm:2_hoer}
Sei $P(x,\D)$ ein Differentialausdruck erster Ordnung mit analytischen Koeffizienten und existiere zu jedem $\omega\Subset\Omega$ 
