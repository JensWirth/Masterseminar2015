...
%
 $\bullet$ \qquad {\sl Schritt 4.} Wir zeigen, dass \eqref{eq:fepsInMN} im Widerspruch zur Existenz der gerade konstruierten Hilfsfunktionen steht. 
...
\end{proof}
\begin{cor}[{\cite[Theorem 2]{Hormander:1960b}}]\label{thm:2_hoer}
