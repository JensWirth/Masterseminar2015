...
Sei $\Omega\subset\mathbb{R}^n$ offen. Seien weiter die Koeffizienten des Differentialausdrucks $P(x,\D)$ analytisch und existiere für jedes $f\in \rmC_0^\infty(\Omega)$  eine distributionelle Lösung $u\in\mathscr D'(\Omega)$ von
\begin{equation}\label{eq:3.1_hoer}
P(x,\D)u=f.
\end{equation}
Dann gilt für alle $x\in\Omega$ und $\xi\in\mathbb{R}^n$ mit $p(x,\xi)$ stets $ \{p,\overline{p}\}(x,\xi)=0$.
%
