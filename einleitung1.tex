...
Weiterhin heißt $P := (  (P^*)_0)^*$ \eIndex[Differentialoperator]{maximaler Operator} zu $\mathcal P$ und $\Omega$.
\end{df}
...
Zu einem Differentialausdruck $\mathcal P$ existieren auf einem Gebiet $\Omega$ genau dann korrekt gestellte Randwertprobleme, wenn $P_0$ und $(P^*)_0$
