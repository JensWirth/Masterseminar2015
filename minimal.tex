...
$P(\xi) =  a \cdot \xi + b$ mit $ a  \in \mathbb{C}^n$, $b \in \mathbb{C}$. Für diese gilt $\Lambda(P)=\{a\}^{\perp}\cap\R^n$ und $M_{C,P}$ ist beschränkt (falls $\Lambda(P)=\{0\}$) oder ein zu $a$ paralleler Streifen. Letzterer ist als Teilmenge des Quotientenraumes $\mathbb{R}^n/\{a\}^{\perp}\simeq a\R$ beschränkt. $\bullet$
