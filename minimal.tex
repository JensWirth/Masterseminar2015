...
$P(\xi) =  a \cdot \xi + b$ mit $ a  \in \mathbb{R}^n$, $b \in \mathbb{R}$. Für diese gilt $\Lambda(P)=\{a\}^{\perp}$ und $M_{C,P}$ ist ein zu $a$ paralleler Streifen. Dieser ist als Teilmenge des Quotientenraumes $\mathbb{R}^n/\{a\}^{\perp}\simeq a\R$ beschränkt. $\bullet$
