...
\begin{df}
\item Seien $V,W$ zwei Banachräume und $T: V \rightarrow W$ ein linearer Operator. Der Operator $T$ heißt \eIndex[Operator]{vollstetig}, falls für jede schwach konvergente Folge $(x_n)_{n \in \mathbb{N}}$ in $V$ die Folge $(Tx_n)_{n \in \mathbb{N}}$ normkonvergent in $W$ ist.
\end{df}
