...
\begin{df}
\item Seien $V,W$ zwei Banachräume und $T: V \rightarrow W$ ein linearer Operator. Sei weiterhin $(x_n)_{n \in \mathbb{N}}$ eine schwach konvergente Folge in $V$ mit
\begin{align*}
x_n \rightharpoonup x \in V , \ \ n \rightarrow \infty. 
\end{align*}
Konvergiert nun die Folge $(Tx_n)_{n \in \mathbb{N}}$ in der Norm in $W$, dann nennt man den Operator $T$ vollstetig.
\end{df}
