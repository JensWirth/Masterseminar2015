...
\end{equation}
den Linienraum\footnote{Dieser wurde von G\r{a}rding eingeführt und beschreibt den größten Unterraum des $\R^n$, so daß das Polynom $P$ auf den Quotienten $\R^n/\Lambda(P)$ projiziert werden kann.} von $P$. Wir nennen $P(\xi)$ \eIndex[Differentialoperator]{vollständig}, wenn $\Lambda(P)=\{0\}$ gilt.
\end{df}
