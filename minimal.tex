...
Als erste Etappe in diesem Kapitel,
führen wir den Vergleich der Stärke (Definition \ref{df:1:1.2})
zweier Differentialausdrücke mit konstanten koeffizienten
auf einen Vergleich der Symbole zurück.

\section{Die Stärke von Differentialausdrücken}

Ziel dieses Abschnitts ist die Charaktierisierung der Aussage
``$\mathcal Q=Q(\D)$ ist schächer als $\mcP=P(\D)$'',
im Fall beschränkter Gebiete $\Om$,
...
Beachte, dass reelle Nullstellen von $P$ in \eqref{eq:2:1} Probleme machen würden,
