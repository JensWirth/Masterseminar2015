...
Sei $P(\D)$ hypoelliptisch. Im folgenden konstruieren wir eine \eIndex[Differentialoperator]{Fundamentallösung} für $P(\D)$, also eine Distribution $E\in\mathscr D'(\R^n)$ mit
\begin{equation}
