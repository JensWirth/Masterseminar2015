...
\end{equation}
und damit falls  $|\eta|<A$ gilt, die Abschätzung $|\zeta|<C'$ für die Nullstelle. Damit ist $P$ vollständig ist und die Bedingung ({\bf i}) von Theorem \ref{thm:3:3.3} ist erfüllt. 
\end{proof}