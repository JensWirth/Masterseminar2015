...
\begin{df}
Der Differentialausdruck $P(\D)$ heißt \eIndex[Differentialoperator]{von lokalem Typ} (auf einem beschränkten Gebiet $\Omega$), falls $u\varphi\in\mathcal D_{P_0}$ für alle $u\in\mathcal D_{P}$ und alle $\varphi\in \rmC_0^\infty(\Omega)$ gilt.
\end{df}
...
Aus {\bf (iv)} folgt, dass jeder Operator von lokalem Typ ein Operator vom Haupttyp sein muß.
\end{exa}
