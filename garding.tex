...
Damit verbleibt es, die Ungleichung \begin{align}
	Q \ge -C\vert\vert v\vert\vert_{\left(-\frac{1}{2}\right)}^2
\end{align}
...
\end{align}
zu zeigen.\\
Für jedes $l\in\{1,\cdots n\}$ gilt für ein $c$ (das wir später wählen) und für $\xi = \pm c(1+\vert \tau\vert)^{\frac{1}{2}}e_l$

\begin{align}
	a(x,\xi+\tau) = a(x,\tau)\pm(1+\vert\tau\vert)^{\frac{1}{2}}a^l(x,\tau) + R(x,\xi,\tau)
\end{align}
Weil $a(x,\xi+\tau)$ positiv definit ist, folgt dass für eine geeignete Konstante $C_1$ auch
\begin{align}
	a(x,\tau) \pm c(1+\vert\tau\vert)^{\frac{1}{2}}a^l(x,\tau)+C_1(1+\vert \tau\vert)\frac{\vert a(x,\cdot\vert_{2}}{\left(1+\vert \tau\vert\right)^2}\ge 0
\end{align}
positiv definit ist.\\
ToDO\\
Ohne Einschränkung sei 
\begin{align}
	p(x) \pm (1+\vert \tau\vert)^{\frac{1}{2}}p^l(x) \ge 0
\end{align}
positiv definit. Dann gilt nach (ToDo: Lemma 2.2)
\begin{align}
	c\left(1+\vert\tau\vert\right)^{\frac{1}{2}} \vert\spro{p^lv^}{v}\vert\le\spro{pv}{v}^{\frac{1}{2}}\spro{pv^l}{v^l}^{\frac{1}{2}}.
\end{align}
Wenden wir darauf die Ungleichung $\sqrt{ab}\le \frac{n}{2}a+\frac{1}{2n}b$ an, so folgt
\begin{align}
	\vert\spro{p^lv^l}{v}\vert\le \frac{1}{2n}\spro{pv}{v}+\frac{n}{2c^2}\frac{1}{1+\vert\tau\vert}\spro{pv^l}{v^l},
\end{align}
was 
\begin{align}
	Q=\spro{pv}{v}+\Re\sum\spro{p^lv^l}{v} \ge \frac{1}{2}\spro{pv}{v} -\frac{n}{2c^2}\frac{1}{1+\vert \tau\vert}\sum\spro{pv^l}{v^l}
\end{align}
impliziert. Lemma \ref{lem3.1:Lax}, angewandt auf $\Phi(\xi) = \xi_l-\tau_l$, liefert in Verbindung mit $(\ref{Abschaetzung 0-Norm})$
\begin{align}
\sum\spro{pv^l}{v^l}=\Re\sum \spro{pv}{\left(D_l-\tau_l\right)v}+\mathcal{O}\left(\vert\vert v\vert\vert_{\left(-\frac{1}{2}\right)}^2\right) 
\end{align}
und damit
\begin{align}
	Q \ge \frac{1}{2}\spro{pv}{v}-\frac{n}{2c^2}\frac{1}{1+\vert \tau\vert}\Re\spro{pv}{\vert D-\tau\vert^2v)}+\mathcal{O}\left(\vert\vert v\vert\vert_{\left(-\frac{1}{2}\right)}^2\right)
\end{align}
oder äquivalent
\begin{align}
	2Q \ge \Re\spro{pv}{\left(1-\frac{n}{2c^2}\frac{\vert D-\tau\vert^2}{1+\vert\tau\vert}\right)v}+\mathcal{O}\left(\vert\vert v\vert\vert_{\left(-\frac{1}{2}\right)}^2\right).
\end{align}
Auf $\supp\widehat{v}$ gilt
\begin{align}
	\frac{\vert\xi-\tau\vert^2}{1+\vert \tau\vert}\le \tilde{C}^2 
\end{align}
für eine Konstante $\tilde{C}>0$. Setzen wir nun $c:=\tilde{C}\sqrt{n}$ und 
\begin{align}
	\Phi(\xi):=\begin{cases}
		\left(1-\frac{n}{2c^2}\frac{\vert \xi-\tau\vert^2}{1+\vert\tau\vert}\right)^{\frac{1}{2}}, &\vert \xi-\tau\vert \le C(1+\vert\tau\vert)^{\frac{1}{2}},\\
		\sqrt{\frac{1}{2}}, & \text{sonst},
	\end{cases}
\end{align}
Dann ist $\Phi(\xi)$ Lipschitz-stetig mit Lipschitz-Konstante $K=\mathcal{O(1+\vert \tau\vert)^{-\frac{1}{2}}}$, erneute Anwendung von Lemma \ref{lem3.1:Lax} liefert
\begin{align}
	2Q \ge \Re\spro{pv}{\Phi(D)^2v}++\mathcal{O}\left(\vert\vert v\vert\vert_{\left(-\frac{1}{2}\right)}^2\right) = \Re\spro{p\Phi(D)v}{\Phi(D)v}+\mathcal{O}\left(\vert\vert v\vert\vert_{\left(-\frac{1}{2}\right)}^2\right).
\end{align}
