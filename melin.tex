...
\end{align}
Mit Hilfe des Taylorrestglieds {\bf ODER ALS INTEGRAL?}
\begin{align}
...
\end{split}
\end{align}
Der erste Term von $H_\delta$ kann wegen $\sum|\psi(\delta\xi)-\psi(\delta\eta)|\le C \braket{\xi-\eta}^2/\abs\xi$ für  $\delta(\abs\eta + \abs\xi)$ groß genug durch
\begin{align}
